...
;; (global-set-key (kbd "<f10>") 'switch-window)
(global-set-key (kbd "<f10>") 'wg-save-wconfig)
(global-set-key (kbd "<f11>") 'wg-restore-saved-wconfig)
(global-set-key [(meta return)] 'toggle-fullscreen)

(global-set-key [?\s-0] 'wg-switch-to-workgroup-at-index-0)
(global-set-key [?\s-1] 'wg-switch-to-workgroup-at-index-1)
(global-set-key [?\s-2] 'wg-switch-to-workgroup-at-index-2)
(global-set-key [?\s-3] 'wg-switch-to-workgroup-at-index-3)
